...
class XTempl_Base
{
	 ...
	 function __construct( $hideAddedCharts = false )
	{
		...
		{
			$this->assign_function("q_graph_001_chart_chart","xt_showchart",
			array(
				"chartName"=>"q_graph_001_chart",
				"table"=>"q_graph_001 Chart",
				"ctype"=>"2DColumn"));
			$this->assign_function("q_graph_002_chart_chart","xt_showchart",
			array(
				"chartName"=>"q_graph_002_chart",
