...
//				$this->strLabel = $params['name'];
	...
	protected function isProjectDB()
	{
		...
		if("007_cdp" == $this->chrt_array['tables'][0])
			return true;
		if("gestionentidad_ver_106_ugrights" == $this->chrt_array['tables'][0])
			return true;
		if("gestionentidad_ver_106_uggroups" == $this->chrt_array['tables'][0])
			return true;
		if("global_users" == $this->chrt_array['tables'][0])
			return true;
		if("q_graph_001" == $this->chrt_array['tables'][0])
			return true;
		if("q_graph_002" == $this->chrt_array['tables'][0])
			return true;
		if("008_reserva" == $this->chrt_array['tables'][0])
			return true;
		return false;
	}
	...
	protected function getPoint( $seriesNumber, $row ) {
		...
		return array( 
				"x" => $strLabelFormat, 
				"value" => $this->chart_xmlencode( (double)str_replace(",", ".", $strDataSeries) ),
