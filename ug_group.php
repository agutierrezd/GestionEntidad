...
$nonAdminTablesArr[] = "q_graph_001 Chart";
$nonAdminTablesArr[] = "q_graph_002 Chart";
$nonAdminTablesArr[] = "008_reserva";
...
$wGroupTableName = $ug_connection->addTableWrappers( "gestionentidad_ver_106_uggroups" );
...
switch(postvalue("a"))
{
	...
	case "del":
		...
		$sql = "delete from ". $ug_connection->addTableWrappers( "gestionentidad_ver_106_ugrights" ) 
	...
	case 'saveRights':
		...
		{	
			...
			$wRightsTableName = $ug_connection->addTableWrappers( "gestionentidad_ver_106_ugrights" );
