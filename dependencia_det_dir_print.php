...
require_once("include/dependencia_det_dir_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "dependencia_det_DIR" );
